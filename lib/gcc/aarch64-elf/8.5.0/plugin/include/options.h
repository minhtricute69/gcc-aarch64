...
enum opt_code
{
  ...
  OPT_mbig_endian = 1194,                    /* -mbig-endian */
  OPT_mcmodel_ = 1195,                       /* -mcmodel= */
  OPT_mcpu_ = 1196,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1197,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1198,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1199,             /* -mgeneral-regs-only */
  ...
  OPT_momit_leaf_frame_pointer = 1204,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1205,               /* -moutline-atomics */
  ...
  OPT_mverbose_cost_dump = 1214,             /* -mverbose-cost-dump */
  OPT_n = 1215,                              /* -n */
  ...
  OPT_nostartfiles = 1221,                   /* -nostartfiles */
  OPT_nostdinc = 1222,                       /* -nostdinc */
  OPT_nostdinc__ = 1223,                     /* -nostdinc++ */
  OPT_nostdlib = 1224,                       /* -nostdlib */
  OPT_o = 1225,                              /* -o */
  OPT_p = 1226,                              /* -p */
  OPT_pass_exit_codes = 1227,                /* -pass-exit-codes */
  /* OPT_pedantic = 1228, */                 /* -pedantic */
  OPT_pedantic_errors = 1229,                /* -pedantic-errors */
  OPT_pg = 1230,                             /* -pg */
  OPT_pie = 1231,                            /* -pie */
  OPT_pipe = 1232,                           /* -pipe */
  OPT_print_file_name_ = 1233,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1234,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1235,          /* -print-multi-directory */
  OPT_print_multi_lib = 1236,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1237,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1238,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1239,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1240,               /* -print-prog-name= */
  OPT_print_search_dirs = 1241,              /* -print-search-dirs */
  OPT_print_sysroot = 1242,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1243,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1244,                          /* -quiet */
  OPT_r = 1245,                              /* -r */
  OPT_remap = 1246,                          /* -remap */
  OPT_s = 1247,                              /* -s */
  OPT_save_temps = 1248,                     /* -save-temps */
  OPT_save_temps_ = 1249,                    /* -save-temps= */
  OPT_shared = 1250,                         /* -shared */
  OPT_shared_libgcc = 1251,                  /* -shared-libgcc */
  /* OPT_specs = 1252, */                    /* -specs */
  OPT_specs_ = 1253,                         /* -specs= */
  OPT_static = 1254,                         /* -static */
  OPT_static_libasan = 1255,                 /* -static-libasan */
  OPT_static_libgcc = 1256,                  /* -static-libgcc */
  OPT_static_libgfortran = 1257,             /* -static-libgfortran */
  OPT_static_libgo = 1258,                   /* -static-libgo */
  OPT_static_liblsan = 1259,                 /* -static-liblsan */
  OPT_static_libmpx = 1260,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1261,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1262,               /* -static-libstdc++ */
  OPT_static_libtsan = 1263,                 /* -static-libtsan */
  OPT_static_libubsan = 1264,                /* -static-libubsan */
  OPT_static_pie = 1265,                     /* -static-pie */
  /* OPT_std_c__03 = 1266, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1267, */                /* -std=c++0x */
  OPT_std_c__11 = 1268,                      /* -std=c++11 */
  OPT_std_c__14 = 1269,                      /* -std=c++14 */
  OPT_std_c__17 = 1270,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1271, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1272, */                /* -std=c++1z */
  OPT_std_c__2a = 1273,                      /* -std=c++2a */
  OPT_std_c__98 = 1274,                      /* -std=c++98 */
  OPT_std_c11 = 1275,                        /* -std=c11 */
  OPT_std_c17 = 1276,                        /* -std=c17 */
  /* OPT_std_c18 = 1277, */                  /* -std=c18 */
  /* OPT_std_c1x = 1278, */                  /* -std=c1x */
  /* OPT_std_c89 = 1279, */                  /* -std=c89 */
  OPT_std_c90 = 1280,                        /* -std=c90 */
  OPT_std_c99 = 1281,                        /* -std=c99 */
  /* OPT_std_c9x = 1282, */                  /* -std=c9x */
  OPT_std_f2003 = 1283,                      /* -std=f2003 */
  OPT_std_f2008 = 1284,                      /* -std=f2008 */
  OPT_std_f2008ts = 1285,                    /* -std=f2008ts */
  OPT_std_f2018 = 1286,                      /* -std=f2018 */
  OPT_std_f95 = 1287,                        /* -std=f95 */
  OPT_std_gnu = 1288,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1289, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1290, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1291,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1292,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1293,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1294, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1295, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1296,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1297,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1298,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1299,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1300, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1301, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1302, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1303,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1304,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1305, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1306, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1307,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1308, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1309, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1310, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1311, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1312, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1313,                     /* -std=legacy */
  OPT_symbolic = 1314,                       /* -symbolic */
  OPT_t = 1315,                              /* -t */
  OPT_time = 1316,                           /* -time */
  OPT_time_ = 1317,                          /* -time= */
  OPT_traditional = 1318,                    /* -traditional */
  OPT_traditional_cpp = 1319,                /* -traditional-cpp */
  OPT_trigraphs = 1320,                      /* -trigraphs */
  OPT_u = 1321,                              /* -u */
  OPT_undef = 1322,                          /* -undef */
  OPT_v = 1323,                              /* -v */
  OPT_version = 1324,                        /* -version */
  OPT_w = 1325,                              /* -w */
  OPT_wrapper = 1326,                        /* -wrapper */
  OPT_x = 1327,                              /* -x */
  OPT_z = 1328,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
